...
const PlayAgain = props => (
    <div className="game-done">
        <div 
            ...
            >
            {props.gameStatus === 'lost'? 'Game Over!!!!!' : 'Nice Job Buddy :)'}
        </div>
...
const Game = (props) => {
    ...
    // We will actually be using the gameId to clear sideeffects
    // we want to clear side-effects by mounting and unmounting the dom component.
    // const resetGame = () => {
...
const StarMatch = () => {
  ...
  // a better way to reset the game state, would be to unmount the StarMatch component
